...
const SignUp = () => {
	...
	<h1 className="text-2xl font-bold text-center text-[#331A15]">Register your account</h1>
	...
	<div className="flex items-center pt-4 space-x-1">
		...
		<p className="px-3 text-md dark:text-gray-600">Login with social accounts</p>
		<div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
	</div>
	<div className="flex justify-center space-x-4">
		<button onClick={handelusergoole} aria-label="Log in with Google" className="p-3 rounded-sm">
	...
	<p className="text-md text-center sm:px-6 dark:text-gray-600"> Your have an account?
		<Link to='/login'><a rel="noopener noreferrer" className="underline dark:text-gray-800 text-[#331A15]">Login</a></Link>
	</p>
</div>
    );
};
